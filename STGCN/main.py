...
from st_gcn.feeder.feeder_hanchoom import Feeder_hanchoom
            ...
            if batch_idx % self.arg.log_interval == 0:
                self.print_log(
                    '\tBatch({}/{}) done. Loss: {:.4f}  lr:{:.6f}'.format(
                        batch_idx, len(loader), loss.data, lr))
...
if __name__ == '__main__':
    ...
    # EVALUATE:  python main.py --config config/st_gcn/kinetics-skeleton/test.yaml
    # TRAIN:  python main.py --config config/st_gcn/<dataset>/train.yaml [--work-dir <work folder>]
    # 알려도 알려도 알려도
    # 알려도 알려도 알려도
    # 알려도 